...
class ZeroSelectTag extends ZeroController
{
    ...
    protected function zeroLoad(){ 
        return [
            ...
            'searchForm' => 'app\\admin\\zero\\form\\ZeroSelectTagSearch',
            'tbname' => '@pf_tag',
            'usePageList' => true,
            'pageSize' => 20,
            'template' => 'ZeroSelectTag.tpl',
            'templateHack' => 'ZeroSelectTag.hack.tpl',
        ];
    }
    ...
    protected function zeroWhere(SqlSelectInterface $selector){ 
          //从搜索表单获取数据
        $search = Form::instance('app\\admin\\zero\\form\\ZeroSelectTagSearch');
