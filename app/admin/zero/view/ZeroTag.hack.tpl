...
{hack fn='_4' rs=null}<a href="{url act='edit' id=$rs.id}"  yee-module='dialog' data-width='600' data-height='340'  class="yee-btn small edit"><i class="icofont icofont-edit"></i>编辑</a>
