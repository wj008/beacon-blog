{extends file='multipleList.tpl'}
{block name='title'}Tag标签{/block}

{block name='listHead'}
<div class="yeeui-optbtns">
 <div class="fl caption">Tag标签</div>
...
<a id="add-btn" href="{url act='add'}"  yee-module='dialog' data-width='600' data-height='340'  class="yee-btn add"><i class="icofont icofont-ui-add"></i>新增</a>
</div></div>
{/block}
...
<th align="left" width="80">TAG名称</th>
